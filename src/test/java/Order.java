...
//Наследует от BaseTest @Before и @After
...
public class Order extends BaseTest {
    ...
    public static Object[][] getOrderData() {
        ...
        ScooterOrderPage objScooterOrderPage = new ScooterOrderPage(BaseTest.driver);
        return new Object[][]{
    ...
    public void TestOrderHeadButton() {
        ScooterMainPage objScooterMainPage = new ScooterMainPage(BaseTest.driver);
        ScooterOrderPage objScooterOrderPage = new ScooterOrderPage(BaseTest.driver);
